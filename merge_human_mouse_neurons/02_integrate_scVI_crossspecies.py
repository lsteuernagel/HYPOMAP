...
# sbatch -J crossspecies_scvi -o /beegfs/scratch/bruening_scratch/lsteuernagel/slurm/other_logs/crossspecies_scvi_slurm-%j.out -e /beegfs/scratch/bruening_scratch/lsteuernagel/slurm/other_logs/crossspecies_scvi_slurm-%j.err integration_pipeline/run_scripts/run_Python_slurm.sh ~/Documents/r_scvi_v3_42.simg merge_human_mouse_neurons/02_integrate_scVI_crossspecies.py /beegfs/scratch/bruening_scratch/lsteuernagel/data/cross_species_hypothalamus_neurons_2_tf/parameters_cross_species_neurons_v2.json
...
data_filepath_full =  parameter_dict["data_filepath_full"]#parameter_dict["harmonization_folder_path"]+parameter_dict["new_name_suffix"]+".h5ad"
